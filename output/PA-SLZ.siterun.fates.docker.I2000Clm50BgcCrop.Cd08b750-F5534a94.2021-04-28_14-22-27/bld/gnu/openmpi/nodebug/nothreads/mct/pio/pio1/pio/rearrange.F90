...
# 34 "/CTSM/cime/src/externals/pio1/pio/rearrange.F90.in"
  interface rearrange_init
    module procedure rearrange_init_
  end interface


# 39 "/CTSM/cime/src/externals/pio1/pio/rearrange.F90.in"
  interface rearrange_create
    module procedure rearrange_create_box_
  end interface

# 43 "/CTSM/cime/src/externals/pio1/pio/rearrange.F90.in"
...
# 48 "/CTSM/cime/src/externals/pio1/pio/rearrange.F90.in"
...
# 53 "/CTSM/cime/src/externals/pio1/pio/rearrange.F90.in"
  interface rearrange_free
    module procedure rearrange_free_
  end interface


# 58 "/CTSM/cime/src/externals/pio1/pio/rearrange.F90.in"
contains
...
# 66 "/CTSM/cime/src/externals/pio1/pio/rearrange.F90.in"
  subroutine rearrange_comp2io_real(Iosystem,iodesc,compbuf,iobuf)
    ...
    call t_startf("PIO:pio_rearrange_comp2io_real")
#endif
...
#ifdef TIMING
    call t_stopf("PIO:pio_rearrange_comp2io_real")
#endif

# 86 "/CTSM/cime/src/externals/pio1/pio/rearrange.F90.in"
...
# 66 "/CTSM/cime/src/externals/pio1/pio/rearrange.F90.in"
  subroutine rearrange_comp2io_double(Iosystem,iodesc,compbuf,iobuf)
    ...
    call t_startf("PIO:pio_rearrange_comp2io_double")
#endif
...
#ifdef TIMING
    call t_stopf("PIO:pio_rearrange_comp2io_double")
#endif
...
# 66 "/CTSM/cime/src/externals/pio1/pio/rearrange.F90.in"
  subroutine rearrange_comp2io_int(Iosystem,iodesc,compbuf,iobuf)
    ...
    call t_startf("PIO:pio_rearrange_comp2io_int")
#endif
...
#ifdef TIMING
    call t_stopf("PIO:pio_rearrange_comp2io_int")
#endif
...
!
# 96 "/CTSM/cime/src/externals/pio1/pio/rearrange.F90.in"
...
#ifdef TIMING
    call t_startf("PIO:pio_rearrange_io2comp_real")
#endif

    call box_rearrange_io2comp(Iosystem,iodesc,size(iobuf),iobuf,size(compbuf),compbuf)

#ifdef TIMING
    call t_stopf("PIO:pio_rearrange_io2comp_real")
#endif

# 114 "/CTSM/cime/src/externals/pio1/pio/rearrange.F90.in"
...
#ifdef TIMING
    call t_startf("PIO:pio_rearrange_io2comp_double")
#endif

    call box_rearrange_io2comp(Iosystem,iodesc,size(iobuf),iobuf,size(compbuf),compbuf)

#ifdef TIMING
    call t_stopf("PIO:pio_rearrange_io2comp_double")
#endif
...
#ifdef TIMING
    call t_startf("PIO:pio_rearrange_io2comp_int")
#endif

    call box_rearrange_io2comp(Iosystem,iodesc,size(iobuf),iobuf,size(compbuf),compbuf)

#ifdef TIMING
    call t_stopf("PIO:pio_rearrange_io2comp_int")
#endif
...
# 125 "/CTSM/cime/src/externals/pio1/pio/rearrange.F90.in"
...
# 134 "/CTSM/cime/src/externals/pio1/pio/rearrange.F90.in"
...
# 144 "/CTSM/cime/src/externals/pio1/pio/rearrange.F90.in"
...
# 172 "/CTSM/cime/src/externals/pio1/pio/rearrange.F90.in"
...
# 184 "/CTSM/cime/src/externals/pio1/pio/rearrange.F90.in"
...
# 203 "/CTSM/cime/src/externals/pio1/pio/rearrange.F90.in"
