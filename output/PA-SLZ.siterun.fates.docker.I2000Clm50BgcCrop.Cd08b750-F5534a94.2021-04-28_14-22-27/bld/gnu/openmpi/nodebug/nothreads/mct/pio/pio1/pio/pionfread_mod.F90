...
!<
  public :: read_nf
# 17 "/CTSM/cime/src/externals/pio1/pio/pionfread_mod.F90.in"
  interface read_nf
...
# 24 "/CTSM/cime/src/externals/pio1/pio/pionfread_mod.F90.in"
contains
...
!! @private
!<
# 30 "/CTSM/cime/src/externals/pio1/pio/pionfread_mod.F90.in"
...
#ifdef TIMING
    call t_startf("PIO:pio_read_nfdarray_real")
#endif
    iotype = File%iotype
    ierr=PIO_noerr
...
#ifdef TIMING
    call t_stopf("PIO:pio_read_nfdarray_real")
#endif

# 209 "/CTSM/cime/src/externals/pio1/pio/pionfread_mod.F90.in"
...
#ifdef TIMING
    call t_startf("PIO:pio_read_nfdarray_double")
#endif
    iotype = File%iotype
    ierr=PIO_noerr
...
! all reads can be parallel in netcdf4 format
    ...
    call check_netcdf(File, ierr,__PIO_FILE__,__LINE__);
#ifdef TIMING
    call t_stopf("PIO:pio_read_nfdarray_double")
#endif
...
#ifdef TIMING
    call t_startf("PIO:pio_read_nfdarray_int")
#endif
    iotype = File%iotype
    ierr=PIO_noerr
...
! all reads can be parallel in netcdf4 format
    ...
    call check_netcdf(File, ierr,__PIO_FILE__,__LINE__);
#ifdef TIMING
    call t_stopf("PIO:pio_read_nfdarray_int")
#endif
