...
!! @private
!<
# 43 "/CTSM/cime/src/externals/pio1/pio/iompi_mod.F90.in"
...
# 48 "/CTSM/cime/src/externals/pio1/pio/iompi_mod.F90.in"
...
# 55 "/CTSM/cime/src/externals/pio1/pio/iompi_mod.F90.in"
contains

# 57 "/CTSM/cime/src/externals/pio1/pio/iompi_mod.F90.in"
...
# 87 "/CTSM/cime/src/externals/pio1/pio/iompi_mod.F90.in"
 end function close_mpiio

# 89 "/CTSM/cime/src/externals/pio1/pio/iompi_mod.F90.in"
...
!        ' File%fh: ',File%fh
     ...
     ierr=0
#endif
# 130 "/CTSM/cime/src/externals/pio1/pio/iompi_mod.F90.in"
 end function create_mpiio

# 132 "/CTSM/cime/src/externals/pio1/pio/iompi_mod.F90.in"
 integer function open_mpiio(File,fname, CheckMPI) result(ierr)
     ...
     ierr=0
#endif
# 174 "/CTSM/cime/src/externals/pio1/pio/iompi_mod.F90.in"
 end function open_mpiio


! TYPE int,real,double
# 178 "/CTSM/cime/src/externals/pio1/pio/iompi_mod.F90.in"
 integer function write_mpiio_int (File,IOBUF,varDesc, iodesc) result(ierr)
    ...
    logical, parameter :: Check = .TRUE.
#ifdef TIMING
    call t_startf("PIO:pio_write_mpiio_int")
#endif
#ifdef USEMPIIO
     datarep   = 'native'
     iotype    = File%iotype
...
#endif
#ifdef TIMING
    call t_stopf("PIO:pio_write_mpiio_int")
#endif

# 246 "/CTSM/cime/src/externals/pio1/pio/iompi_mod.F90.in"
...
# 178 "/CTSM/cime/src/externals/pio1/pio/iompi_mod.F90.in"
 integer function write_mpiio_real (File,IOBUF,varDesc, iodesc) result(ierr)
    ...
    logical, parameter :: Check = .TRUE.
#ifdef TIMING
    call t_startf("PIO:pio_write_mpiio_real")
#endif
#ifdef USEMPIIO
     datarep   = 'native'
     iotype    = File%iotype
...
#endif
#ifdef TIMING
    call t_stopf("PIO:pio_write_mpiio_real")
#endif
...
# 178 "/CTSM/cime/src/externals/pio1/pio/iompi_mod.F90.in"
 integer function write_mpiio_double (File,IOBUF,varDesc, iodesc) result(ierr)
    ...
    logical, parameter :: Check = .TRUE.
#ifdef TIMING
    call t_startf("PIO:pio_write_mpiio_double")
#endif
#ifdef USEMPIIO
     datarep   = 'native'
     iotype    = File%iotype
...
#endif
#ifdef TIMING
    call t_stopf("PIO:pio_write_mpiio_double")
#endif
...
! TYPE int,real,double
# 249 "/CTSM/cime/src/externals/pio1/pio/iompi_mod.F90.in"
 integer function read_mpiio_int (File,IOBUF,varDesc, iodesc) result(ierr)
    ...
    logical, parameter :: Check = .TRUE.
     ...
     offset    = iodesc%IOmap%start
#ifdef TIMING
    call t_startf("PIO:pio_read_mpiio_int")
#endif
#ifdef USEMPIIO
     reclen=glen*c_sizeof(iobuf(1))
...
#endif
#ifdef TIMING
    call t_stopf("PIO:pio_read_mpiio_int")
#endif
# 316 "/CTSM/cime/src/externals/pio1/pio/iompi_mod.F90.in"
...
# 249 "/CTSM/cime/src/externals/pio1/pio/iompi_mod.F90.in"
 integer function read_mpiio_real (File,IOBUF,varDesc, iodesc) result(ierr)
    ...
    logical, parameter :: Check = .TRUE.
     ...
     offset    = iodesc%IOmap%start
#ifdef TIMING
    call t_startf("PIO:pio_read_mpiio_real")
#endif
#ifdef USEMPIIO
     reclen=glen*c_sizeof(iobuf(1))
...
#endif
#ifdef TIMING
    call t_stopf("PIO:pio_read_mpiio_real")
#endif
# 316 "/CTSM/cime/src/externals/pio1/pio/iompi_mod.F90.in"
...
# 249 "/CTSM/cime/src/externals/pio1/pio/iompi_mod.F90.in"
 integer function read_mpiio_double (File,IOBUF,varDesc, iodesc) result(ierr)
    ...
    logical, parameter :: Check = .TRUE.
     ...
     offset    = iodesc%IOmap%start
#ifdef TIMING
    call t_startf("PIO:pio_read_mpiio_double")
#endif
#ifdef USEMPIIO
     reclen=glen*c_sizeof(iobuf(1))
...
#endif
#ifdef TIMING
    call t_stopf("PIO:pio_read_mpiio_double")
#endif
# 316 "/CTSM/cime/src/externals/pio1/pio/iompi_mod.F90.in"
 end function read_mpiio_double


# 319 "/CTSM/cime/src/externals/pio1/pio/iompi_mod.F90.in"
...
# 356 "/CTSM/cime/src/externals/pio1/pio/iompi_mod.F90.in"
 end subroutine Write_FORTRAN_CntrlWord
!***********************************************************************
# 358 "/CTSM/cime/src/externals/pio1/pio/iompi_mod.F90.in"
 subroutine Read_FORTRAN_CntrlWord(File,reclen)
     ...
     call piodie(__PIO_FILE__,__LINE__,'PIO was not built with -DUSEMPIIO')
#endif
# 391 "/CTSM/cime/src/externals/pio1/pio/iompi_mod.F90.in"
