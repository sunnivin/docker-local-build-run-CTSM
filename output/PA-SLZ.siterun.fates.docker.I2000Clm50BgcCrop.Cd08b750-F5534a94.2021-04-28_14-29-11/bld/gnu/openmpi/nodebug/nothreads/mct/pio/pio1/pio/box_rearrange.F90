...
# 67 "/CTSM/cime/src/externals/pio1/pio/box_rearrange.F90.in"
...
# 72 "/CTSM/cime/src/externals/pio1/pio/box_rearrange.F90.in"
...
# 84 "/CTSM/cime/src/externals/pio1/pio/box_rearrange.F90.in"
contains
!>
...
# 92 "/CTSM/cime/src/externals/pio1/pio/box_rearrange.F90.in"
...
#ifdef TIMING
      call t_startf("PIO:a2a_box_rear_comp2io_real")
#endif
...
#ifdef TIMING
      call t_stopf("PIO:a2a_box_rear_comp2io_real")
#endif
      call CheckMPIReturn('box_rearrange', ierror)
    else
#ifdef TIMING
      call t_startf("PIO:swapm_box_rear_comp2io_real")
#endif
...
#ifdef TIMING
       call t_stopf("PIO:swapm_box_rear_comp2io_real")
#endif
    endif
...
#ifdef TIMING
    call t_startf("PIO:p2p_box_rear_comp2io_real")
#endif
    !
...
#ifdef TIMING
    call t_stopf("PIO:p2p_box_rear_comp2io_real")
#endif
...
# 389 "/CTSM/cime/src/externals/pio1/pio/box_rearrange.F90.in"
...
#ifdef TIMING
      call t_startf("PIO:a2a_box_rear_comp2io_double")
#endif
      call MPI_ALLTOALLW(src,  a2a_sendcounts, a2a_displs, a2a_sendtypes, &
                         dest, a2a_recvcounts, a2a_displs, a2a_recvtypes, &
                         IOsystem%union_comm, ierror                       )
#ifdef TIMING
      call t_stopf("PIO:a2a_box_rear_comp2io_double")
#endif
      call CheckMPIReturn('box_rearrange', ierror)
    else
#ifdef TIMING
      call t_startf("PIO:swapm_box_rear_comp2io_double")
#endif
      call pio_swapm( nprocs, myrank,                            &
        src,  ndof,   a2a_sendcounts, a2a_displs, a2a_sendtypes, &
        dest, niodof, a2a_recvcounts, a2a_displs, a2a_recvtypes, &
        IOsystem%union_comm, pio_hs, pio_isend, pio_maxreq        )
#ifdef TIMING
       call t_stopf("PIO:swapm_box_rear_comp2io_double")
#endif
    endif
    call dealloc_check(a2a_sendcounts)
    call dealloc_check(a2a_displs)
...
#ifdef TIMING
    call t_startf("PIO:p2p_box_rear_comp2io_double")
#endif
    !
    ! send data from comp procs
    !
...
#ifdef TIMING
    call t_stopf("PIO:p2p_box_rear_comp2io_double")
#endif
...
#ifdef TIMING
      call t_startf("PIO:a2a_box_rear_comp2io_int")
#endif
      call MPI_ALLTOALLW(src,  a2a_sendcounts, a2a_displs, a2a_sendtypes, &
                         dest, a2a_recvcounts, a2a_displs, a2a_recvtypes, &
                         IOsystem%union_comm, ierror                       )
#ifdef TIMING
      call t_stopf("PIO:a2a_box_rear_comp2io_int")
#endif
      call CheckMPIReturn('box_rearrange', ierror)
    else
#ifdef TIMING
      call t_startf("PIO:swapm_box_rear_comp2io_int")
#endif
      call pio_swapm( nprocs, myrank,                            &
        src,  ndof,   a2a_sendcounts, a2a_displs, a2a_sendtypes, &
        dest, niodof, a2a_recvcounts, a2a_displs, a2a_recvtypes, &
        IOsystem%union_comm, pio_hs, pio_isend, pio_maxreq        )
#ifdef TIMING
       call t_stopf("PIO:swapm_box_rear_comp2io_int")
#endif
    endif
    call dealloc_check(a2a_sendcounts)
    call dealloc_check(a2a_displs)
...
#ifdef TIMING
    call t_startf("PIO:p2p_box_rear_comp2io_int")
#endif
    !
    ! send data from comp procs
    !
...
#ifdef TIMING
    call t_stopf("PIO:p2p_box_rear_comp2io_int")
#endif
...
! TYPE real,double,int
# 392 "/CTSM/cime/src/externals/pio1/pio/box_rearrange.F90.in"
...
#ifdef TIMING
      call t_startf("PIO:a2a_box_rear_io2comp_real")
#endif
      call MPI_ALLTOALLW(iobuf,   a2a_sendcounts, a2a_displs, a2a_sendtypes, &
                         compbuf, a2a_recvcounts, a2a_displs, a2a_recvtypes, &
                         IOsystem%union_comm, ierror                          )
#ifdef TIMING
      call t_stopf("PIO:a2a_box_rear_io2comp_real")
#endif
      call CheckMPIReturn(subName, ierror)
    else

#ifdef TIMING
      call t_startf("PIO:swapm_box_rear_io2comp_real")
#endif
      call pio_swapm( nprocs, myrank,                               &
        ...
        IOsystem%union_comm, pio_hs, pio_isend, pio_maxreq           )
#ifdef TIMING
      call t_stopf("PIO:swapm_box_rear_io2comp_real")
#endif
    endif
    call dealloc_check(a2a_sendcounts)
    call dealloc_check(a2a_displs)
...
#ifdef TIMING
    call t_startf("PIO:p2p_box_rear_io2comp_real")
#endif
...
#ifdef TIMING
    call t_stopf("PIO:p2p_box_rear_io2comp_real")
#endif

  endif ! POINT_TO_POINT
#endif  /* not _MPISERIAL */

# 684 "/CTSM/cime/src/externals/pio1/pio/box_rearrange.F90.in"
...
#ifdef TIMING
      call t_startf("PIO:a2a_box_rear_io2comp_double")
#endif
      call MPI_ALLTOALLW(iobuf,   a2a_sendcounts, a2a_displs, a2a_sendtypes, &
                         compbuf, a2a_recvcounts, a2a_displs, a2a_recvtypes, &
                         IOsystem%union_comm, ierror                          )
#ifdef TIMING
      call t_stopf("PIO:a2a_box_rear_io2comp_double")
#endif
      call CheckMPIReturn(subName, ierror)
    else

#ifdef TIMING
      call t_startf("PIO:swapm_box_rear_io2comp_double")
#endif
      call pio_swapm( nprocs, myrank,                               &
        iobuf,   niodof, a2a_sendcounts, a2a_displs, a2a_sendtypes, &
        compbuf, ndof,   a2a_recvcounts, a2a_displs, a2a_recvtypes, &
        IOsystem%union_comm, pio_hs, pio_isend, pio_maxreq           )
#ifdef TIMING
      call t_stopf("PIO:swapm_box_rear_io2comp_double")
#endif
    endif
    call dealloc_check(a2a_sendcounts)
    call dealloc_check(a2a_displs)
...
#ifdef TIMING
    call t_startf("PIO:p2p_box_rear_io2comp_double")
#endif
    call alloc_check(rreq, num_iotasks, 'recv requests')
...
#ifdef TIMING
    call t_stopf("PIO:p2p_box_rear_io2comp_double")
#endif
...
#ifdef TIMING
      call t_startf("PIO:a2a_box_rear_io2comp_int")
#endif
      call MPI_ALLTOALLW(iobuf,   a2a_sendcounts, a2a_displs, a2a_sendtypes, &
                         compbuf, a2a_recvcounts, a2a_displs, a2a_recvtypes, &
                         IOsystem%union_comm, ierror                          )
#ifdef TIMING
      call t_stopf("PIO:a2a_box_rear_io2comp_int")
#endif
      call CheckMPIReturn(subName, ierror)
    else

#ifdef TIMING
      call t_startf("PIO:swapm_box_rear_io2comp_int")
#endif
      call pio_swapm( nprocs, myrank,                               &
        iobuf,   niodof, a2a_sendcounts, a2a_displs, a2a_sendtypes, &
        compbuf, ndof,   a2a_recvcounts, a2a_displs, a2a_recvtypes, &
        IOsystem%union_comm, pio_hs, pio_isend, pio_maxreq           )
#ifdef TIMING
      call t_stopf("PIO:swapm_box_rear_io2comp_int")
#endif
    endif
    call dealloc_check(a2a_sendcounts)
    call dealloc_check(a2a_displs)
...
#ifdef TIMING
    call t_startf("PIO:p2p_box_rear_io2comp_int")
#endif
    call alloc_check(rreq, num_iotasks, 'recv requests')
...
#ifdef TIMING
    call t_stopf("PIO:p2p_box_rear_io2comp_int")
#endif
...
# 693 "/CTSM/cime/src/externals/pio1/pio/box_rearrange.F90.in"
...
# 700 "/CTSM/cime/src/externals/pio1/pio/box_rearrange.F90.in"
...
# 709 "/CTSM/cime/src/externals/pio1/pio/box_rearrange.F90.in"
...
# 734 "/CTSM/cime/src/externals/pio1/pio/box_rearrange.F90.in"
...
# 745 "/CTSM/cime/src/externals/pio1/pio/box_rearrange.F90.in"
...
# 817 "/CTSM/cime/src/externals/pio1/pio/box_rearrange.F90.in"
...
# 827 "/CTSM/cime/src/externals/pio1/pio/box_rearrange.F90.in"
...
# 923 "/CTSM/cime/src/externals/pio1/pio/box_rearrange.F90.in"
...
!!
!<
# 937 "/CTSM/cime/src/externals/pio1/pio/box_rearrange.F90.in"
...
# 1083 "/CTSM/cime/src/externals/pio1/pio/box_rearrange.F90.in"
...
!<
#ifndef _MPISERIAL
# 1091 "/CTSM/cime/src/externals/pio1/pio/box_rearrange.F90.in"
...
# 1605 "/CTSM/cime/src/externals/pio1/pio/box_rearrange.F90.in"
...
# 1614 "/CTSM/cime/src/externals/pio1/pio/box_rearrange.F90.in"
...
# 1680 "/CTSM/cime/src/externals/pio1/pio/box_rearrange.F90.in"
