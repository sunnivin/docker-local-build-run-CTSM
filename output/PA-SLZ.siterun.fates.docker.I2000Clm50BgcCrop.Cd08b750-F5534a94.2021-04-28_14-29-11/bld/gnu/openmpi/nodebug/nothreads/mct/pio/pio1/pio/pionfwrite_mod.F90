...
!<
  public :: write_nf
# 16 "/CTSM/cime/src/externals/pio1/pio/pionfwrite_mod.F90.in"
  interface write_nf
...
# 24 "/CTSM/cime/src/externals/pio1/pio/pionfwrite_mod.F90.in"
contains
...
!! @private
!<
# 32 "/CTSM/cime/src/externals/pio1/pio/pionfwrite_mod.F90.in"
...
#ifdef TIMING
    call t_startf("PIO:pio_write_nfdarray_real")
#endif
    ierr = PIO_NOERR
...
#ifdef TIMING
    call t_stopf("PIO:pio_write_nfdarray_real")
#endif
!  call mpi_barrier(file%iosystem%comp_comm, mpierr)
!  call CheckMPIReturn(subName,mpierr)

# 257 "/CTSM/cime/src/externals/pio1/pio/pionfwrite_mod.F90.in"
...
#ifdef TIMING
    call t_startf("PIO:pio_write_nfdarray_int")
#endif
    ierr = PIO_NOERR
    if(file%iosystem%ioproc) then
       iotype = File%iotype
...
!               '  IAM: ',File%iosystem%io_rank,'minval: ',minval(IOBUF),'maxval: ',maxval(IOBUF)
    ...
    call check_netcdf(File, ierr,subname,__LINE__)
#ifdef TIMING
    call t_stopf("PIO:pio_write_nfdarray_int")
#endif
!  call mpi_barrier(file%iosystem%comp_comm, mpierr)
!  call CheckMPIReturn(subName,mpierr)
...
#ifdef TIMING
    call t_startf("PIO:pio_write_nfdarray_double")
#endif
    ierr = PIO_NOERR
    if(file%iosystem%ioproc) then
       iotype = File%iotype
...
!               '  IAM: ',File%iosystem%io_rank,'minval: ',minval(IOBUF),'maxval: ',maxval(IOBUF)
    ...
    call check_netcdf(File, ierr,subname,__LINE__)
#ifdef TIMING
    call t_stopf("PIO:pio_write_nfdarray_double")
#endif
!  call mpi_barrier(file%iosystem%comp_comm, mpierr)
!  call CheckMPIReturn(subName,mpierr)
