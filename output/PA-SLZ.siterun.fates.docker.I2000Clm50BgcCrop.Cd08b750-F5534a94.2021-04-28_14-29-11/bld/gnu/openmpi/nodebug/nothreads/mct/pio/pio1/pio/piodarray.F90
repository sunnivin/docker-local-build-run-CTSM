...
!<
# 59 "/CTSM/cime/src/externals/pio1/pio/piodarray.F90.in"
...
!<
# 70 "/CTSM/cime/src/externals/pio1/pio/piodarray.F90.in"
...
# 75 "/CTSM/cime/src/externals/pio1/pio/piodarray.F90.in"
...
!! @private
!<
# 82 "/CTSM/cime/src/externals/pio1/pio/piodarray.F90.in"
...
#ifdef _COMPRESSION
# 88 "/CTSM/cime/src/externals/pio1/pio/piodarray.F90.in"
  interface
# 89 "/CTSM/cime/src/externals/pio1/pio/piodarray.F90.in"
...
# 95 "/CTSM/cime/src/externals/pio1/pio/piodarray.F90.in"
     end subroutine WriteVDC2Var
  end interface
# 97 "/CTSM/cime/src/externals/pio1/pio/piodarray.F90.in"
  interface
# 98 "/CTSM/cime/src/externals/pio1/pio/piodarray.F90.in"
     subroutine ReadVDC2Var(iobuf, start, kount, iocomm, ts, lod, reflevel, iotasks, name) bind(C)
       ...
       integer(c_int), intent(in), value :: iocomm, ts, lod, reflevel, iotasks
       type(c_ptr), intent(in), value :: name
# 104 "/CTSM/cime/src/externals/pio1/pio/piodarray.F90.in"
...
# 116 "/CTSM/cime/src/externals/pio1/pio/piodarray.F90.in"
contains

# 118 "/CTSM/cime/src/externals/pio1/pio/piodarray.F90.in"
...
# 127 "/CTSM/cime/src/externals/pio1/pio/piodarray.F90.in"
  end subroutine pio_set_buffer_size_limit_i4

# 129 "/CTSM/cime/src/externals/pio1/pio/piodarray.F90.in"
...
# 137 "/CTSM/cime/src/externals/pio1/pio/piodarray.F90.in"
...
!<
# 153 "/CTSM/cime/src/externals/pio1/pio/piodarray.F90.in"
...
# 235 "/CTSM/cime/src/externals/pio1/pio/piodarray.F90.in"
...
!! @param fillval : An optional fill value to fill holes in the data written
!<
# 251 "/CTSM/cime/src/externals/pio1/pio/piodarray.F90.in"
...
#endif
# 296 "/CTSM/cime/src/externals/pio1/pio/piodarray.F90.in"
...
!! @param iostat : The status returned from this routine (see \ref PIO_seterrorhandling for details)
!<
# 310 "/CTSM/cime/src/externals/pio1/pio/piodarray.F90.in"
...
# 372 "/CTSM/cime/src/externals/pio1/pio/piodarray.F90.in"
...
!! @param iostat : The status returned from this routine (see \ref PIO_seterrorhandling for details)
!<
# 387 "/CTSM/cime/src/externals/pio1/pio/piodarray.F90.in"
...
# 410 "/CTSM/cime/src/externals/pio1/pio/piodarray.F90.in"
...
!! @param fillval : An optional fill value to fill holes in the data written
!<
# 424 "/CTSM/cime/src/externals/pio1/pio/piodarray.F90.in"
...
#endif
# 685 "/CTSM/cime/src/externals/pio1/pio/piodarray.F90.in"
...
!! @param fillval : An optional fill value to fill holes in the data written
!<
# 699 "/CTSM/cime/src/externals/pio1/pio/piodarray.F90.in"
...
!!!!!!! end debug
    ...
    call t_stopf("PIO:pio_write_darray")
#endif
# 869 "/CTSM/cime/src/externals/pio1/pio/piodarray.F90.in"
...
!! @param iostat : The status returned from this routine (see \ref PIO_seterrorhandling for details)
!<
# 884 "/CTSM/cime/src/externals/pio1/pio/piodarray.F90.in"
...
# 1069 "/CTSM/cime/src/externals/pio1/pio/piodarray.F90.in"
...
!! @param iostat : The status returned from this routine (see \ref PIO_seterrorhandling for details)
!<
# 1083 "/CTSM/cime/src/externals/pio1/pio/piodarray.F90.in"
...
# 1238 "/CTSM/cime/src/externals/pio1/pio/piodarray.F90.in"
...
# 1238 "/CTSM/cime/src/externals/pio1/pio/piodarray.F90.in"
  ...
  ! TYPE real,int,double
# 1241 "/CTSM/cime/src/externals/pio1/pio/piodarray.F90.in"
...
# 1283 "/CTSM/cime/src/externals/pio1/pio/piodarray.F90.in"
...
# 1287 "/CTSM/cime/src/externals/pio1/pio/piodarray.F90.in"
...
#endif
# 1351 "/CTSM/cime/src/externals/pio1/pio/piodarray.F90.in"
  end subroutine darray_write_complete


#ifdef _COMPRESSION

# 1356 "/CTSM/cime/src/externals/pio1/pio/piodarray.F90.in"
...
#endif
# 1466 "/CTSM/cime/src/externals/pio1/pio/piodarray.F90.in"
  end subroutine write_vdc2_real

# 1468 "/CTSM/cime/src/externals/pio1/pio/piodarray.F90.in"
...
# 1554 "/CTSM/cime/src/externals/pio1/pio/piodarray.F90.in"
