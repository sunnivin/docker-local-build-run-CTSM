...
#
# Example usage:
# ./scripts/ctsm_brazil_ozone_sunnivin.sh --site_name=PA-SLZ --compset=I2000Clm50BgcCrop  --start_year='2012-01-01' --num_years=3 --run_type=startup --met_start=2010  --met_end=2014 --resolution=0.9x1.25 --output_vars=output_vars.txt --output_freq=H  --descname=siterun --debug=FALSE
#
#
#
# Script details:
...
#default_vars= 'TOTECOSYSC', 'TOTECOSYSN', 'TOTSOMC', 'TOTSOMN', 'TOTVEGC',\'TOTVEGN', 'TLAI', 'GPP', 'CPOOL', 'NPP', 'TWS','PSNSUN', 'PSNSHA', 'RSSUN', 'RSSHA',\'GSSUN', 'GSSHA', 'Vcmx25Z', 'Jmx25Z', 'VCMX25T', 'JMX25T'
# =======================================================================================
...
compset="${compset:-I2000Clm50BgcCrop}"
resolution="${resolution:-1x1_brazil}"
...
pattern=${datmdata_dir}/atm_forcing.datm7.GSWP3.0.5d.v1.c170516/"domain.lnd.1x1pt-brazil*"
...
pattern=${datm_data_root}/"domain.lnd.1x1pt*"
domain_lnd=( $pattern )
...
pattern=${datm_data_root}/"surfdata_1x1_brazil*"
surfdata=( $pattern )
...
# ./xmlchange NTASKS_LND=1,ROOTPE_LND=1,NTHRDS_LND=1
